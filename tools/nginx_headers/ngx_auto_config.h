#define NGX_CONFIGURE " --prefix=/opt/nginx --with-debug --with-cc-opt='-Wall -Werror -g3 -O0 -fno-omit-frame-pointer' --with-http_sub_module --with-stream_ssl_preread_module --with-http_realip_module --with-stream_realip_module --with-http_stub_status_module --with-http_v2_module --with-stream --with-stream_ssl_module --with-http_ssl_module --http-fastcgi-temp-path=/dev/null --http-uwsgi-temp-path=/dev/null --http-scgi-temp-path=/dev/null --http-client-body-temp-path=logs/client-body-temp --http-proxy-temp-path=logs/proxy-temp"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 14.2.0 (Debian 14.2.0-16) "
#endif
...
#define NGX_HTTP_CLIENT_TEMP_PATH  "logs/client-body-temp"
#endif


#ifndef NGX_HTTP_PROXY_TEMP_PATH
#define NGX_HTTP_PROXY_TEMP_PATH  "logs/proxy-temp"
#endif


#ifndef NGX_HTTP_FASTCGI_TEMP_PATH
#define NGX_HTTP_FASTCGI_TEMP_PATH  "/dev/null"
#endif


#ifndef NGX_HTTP_UWSGI_TEMP_PATH
#define NGX_HTTP_UWSGI_TEMP_PATH  "/dev/null"
#endif


#ifndef NGX_HTTP_SCGI_TEMP_PATH
#define NGX_HTTP_SCGI_TEMP_PATH  "/dev/null"
#endif
